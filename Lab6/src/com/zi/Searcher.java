...
public class Searcher {
    ...
    public static void main(String args[]) {
        ...
        TermQuery tq2;
        {
            ...
            Term term2 = new Term(Constants.content, queryBird);
        ...
        // Boolean query
        {
            ...
            BooleanQuery bq = new BooleanQuery.Builder()
                    ...
                    .build();
            BooleanQuery mainQuerry = new BooleanQuery.Builder()
                    .add(new BooleanClause(bq, BooleanClause.Occur.MUST))
                    .build();
            printResultsForQuery(indexSearcher, mainQuerry);
            // --------------------------------------
        }
        ...
        // For this reason, construct PrefixQuery.
        {
            ...
            Query tq3 = IntPoint.newRangeQuery(Constants.filesize, 0, 1000);
        ...
        // Which documents have been found?
        {
            ...
            Query fq = new FuzzyQuery(fuzzyTerm);
        ...
        // to query object, and find relevant documents. Analyze the outcomes.
        {
            ...
            try {
                ...
                Query lastQuery = queryParser.parse(selectedQuery);
                printResultsForQuery(indexSearcher, lastQuery);
            } catch (ParseException e) {System.out.println("Coulnd't find any matching documents");}
    ...
    private static void printResultsForQuery(IndexSearcher indexSearcher, Query q) {
        ...
        try {
            TopDocs search = indexSearcher.search(q, Constants.top_docs);
            for (ScoreDoc score : search.scoreDocs) {
                Document document = indexSearcher.doc(score.doc);
                System.out.println(score.score + ": " + document.get(Constants.filename) + " " + document.get(Constants.id) + " " + document.get(Constants.filesize));
            }
        } catch (IOException e) {}
